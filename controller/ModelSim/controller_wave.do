# Controller testbench wave.do file, Cameron Archibald B00893056, Nader Hdeib B00898627
onerror {resume}
...
add wave -noupdate -label STATE -radix unsigned         /controller_tb/U1/state
add wave -noupdate -label GAME_STATE -radix unsigned    /controller_tb/U1/game_state
...
add wave -noupdate -label val1_player           /controller_tb/U1/val1_player
add wave -noupdate -label val2_player           /controller_tb/U1/val2_player
add wave -noupdate -label val1_house            /controller_tb/U1/val1_house
add wave -noupdate -label val2_house            /controller_tb/U1/val2_house
add wave -noupdate -label val2_17               /controller_tb/U1/val2_17
add wave -noupdate -label val2_21               /controller_tb/U1/val2_21
add wave -noupdate -label LESS_THAN             /controller_tb/U1/cp_lt
add wave -noupdate -label EQUAL_TO              /controller_tb/U1/cp_eq
add wave -noupdate -label GREATER_THAN          /controller_tb/U1/cp_gt
...
add wave -noupdate -label PLAYER_HAND           /controller_tb/U1/player_hand
add wave -noupdate -label HOUSE_HAND            /controller_tb/U1/house_hand
add wave -noupdate -label PLAYER_HAND_INDEX     /controller_tb/U1/player_hand_index
add wave -noupdate -label HOUSE_HAND_INDEX     /controller_tb/U1/house_hand_index
